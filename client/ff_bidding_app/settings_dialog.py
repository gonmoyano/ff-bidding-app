...
class ManageVendorsDialog(QtWidgets.QDialog):
    ...
    def _build_ui(self):
        ...
        self.vendors_table.horizontalHeader().setSectionResizeMode(0, QtWidgets.QHeaderView.Interactive)
        self.vendors_table.horizontalHeader().setSectionResizeMode(1, QtWidgets.QHeaderView.Interactive)
...
class VendorsTab(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.vendor_table.horizontalHeader().setSectionResizeMode(0, QtWidgets.QHeaderView.Interactive)
        self.vendor_table.horizontalHeader().setSectionResizeMode(1, QtWidgets.QHeaderView.Interactive)
