...
class VFXBreakdownWidget(QtWidgets.QWidget):
    ...
    def eventFilter(self, obj, event):
        """Event filter to handle keyboard shortcuts and mouse events.

        Clipboard shortcuts (Ctrl+C/V) must be handled here because QTableView's
        ...
        if obj == self.table_view and event.type() == QtCore.QEvent.KeyPress:
            ...
            # Clipboard shortcuts - handle directly to prevent QTableView interception
            if has_ctrl:
