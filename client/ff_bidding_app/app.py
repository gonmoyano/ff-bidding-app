...
# Cloud refresh icon (from Material Design Icons - https://pictogrammers.com/library/mdi/icon/cloud-refresh-variant-outline/)
CLOUD_REFRESH_OUTLINE_SVG_PATH = "M21.86 12.5C21.1 11.63 20.15 11.13 19 11C19 9.05 18.32 7.44 16.96 6.04C15.6 4.68 13.95 4 12 4C10.42 4 9 4.47 7.75 5.43C6.5 6.39 5.67 7.62 5.25 9.15C4 9.43 2.96 10.08 2.17 11.1C1.39 12.13 1 13.28 1 14.58C1 16.09 1.54 17.38 2.61 18.43C3.69 19.5 5 20 6.5 20H18.5C19.75 20 20.81 19.56 21.69 18.69C22.56 17.81 23 16.75 23 15.5C23 14.35 22.62 13.35 21.86 12.5M20.27 17.27C19.79 17.76 19.2 18 18.5 18H6.5C5.53 18 4.71 17.66 4.03 16.97C3.34 16.29 3 15.47 3 14.5C3 13.53 3.34 12.71 4.03 12.03C4.71 11.34 5.53 11 6.5 11H7V10C7 8.62 7.5 7.44 8.46 6.46C9.44 5.5 10.62 5 12 5C13.38 5 14.56 5.5 15.54 6.46C16.5 7.44 17 8.62 17 10V11H18.5C19.2 11 19.79 11.24 20.27 11.73C20.76 12.21 21 12.8 21 13.5C21 14.2 20.76 14.79 20.27 15.27M12 12H14.5L12 9.5V12M12 17.5L14.5 15H12V12.5L9.5 15H12V17.5Z"
...
class PackageManagerApp(QtWidgets.QMainWindow):
    ...
    def _create_top_bar(self):
        ...
        load_sg_btn.setIcon(create_icon_from_svg_path(CLOUD_REFRESH_OUTLINE_SVG_PATH, size=20, color="#e0e0e0"))
